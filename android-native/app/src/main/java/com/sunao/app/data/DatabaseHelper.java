...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Seed initial chats
        db.execSQL("INSERT OR REPLACE INTO chats VALUES ('1', 'Rahul Kumar', '9876543210', 'Ekdum mast calling working hai!', '10:30 AM', 0)");
        db.execSQL("INSERT OR REPLACE INTO chats VALUES ('2', 'Team Sunao', '9123456789', 'Pure Native Android architecture active.', '09:15 AM', 1)");
    }
    ...
    public List<Chat> getAllChats() {
        ...
        Cursor c = db.rawQuery("SELECT * FROM chats ORDER BY timestamp DESC", null);
        if (c.moveToFirst()) {
            do {
                list.add(new Chat(
                        c.getString(0),
